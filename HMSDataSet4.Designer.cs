...
SELECT Name, FatherName, CNIC, DateOfBirth, BloodGroup, Adress, MobileNumber, Institute, Class, GuardianName, GuardianNumber, DatteOfRegistration FROM tbl_Student WHERE (CNIC = @CNIC)";
        ...
        public virtual int Fill(HMSDataSet4.tbl_StudentDataTable dataTable) {
        ...
        public virtual HMSDataSet4.tbl_StudentDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            HMSDataSet4.tbl_StudentDataTable dataTable = new HMSDataSet4.tbl_StudentDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(HMSDataSet4.tbl_StudentDataTable dataTable) {
